...
<!DOCTYPE html>
    <html lang="en">
        ...
        <div class="login-form">
            ...
            <form action="inscription_traitement_admin.php" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="droit" class="form-control" placeholder="Privileges" required="required" autocomplete="off">
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block">Sign up</button>
                </div>   
            </form>
     <p class="text-center"><a href="../dashboard/index.php">Cancel</a></p>
   </div>
        <style>
            .login-form {
                width: 340px;
