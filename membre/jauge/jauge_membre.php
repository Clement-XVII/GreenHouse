...
//'2021-04-13 00:00:00'
$sql = "SELECT time, temp,hum,hc,humsol,sondetemp,gas,gas2 FROM sensor ORDER BY id DESC";
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="../jauge/jauge_membre.php">
