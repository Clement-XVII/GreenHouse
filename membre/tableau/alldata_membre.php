      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" href="../dashboard/dashboard_membre.php">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../tableau/tableau_membre.php">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <a type="button" class="btn btn-sm btn-outline-secondary " href='../test.sql'>Recover SQL</a>
          </div>
        </div>
        <script>
          function Export() {
        ...
        <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <a href='tableau_membre.php' class='btn btn-light'>Go back</a>
                  </div>
                </div>
              </form>
        <!-- ********************************************************************************************************************************************************************************************* -->
